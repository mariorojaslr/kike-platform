    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
            <div>
                ...
                <small class="text-white-50"><i class="fas fa-calendar-alt me-1 text-info"></i> Período en Cierre: <strong class="text-white">{{ $periodoActual }}</strong></small>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('liquidacion.exportar_interbanking') }}" class="btn btn-outline-info rounded-pill px-4 fw-bold shadow-sm">
                    <i class="fas fa-file-export me-1"></i> Exportar Interbanking (CBU/Alias)
                </a>
                <button type="button" class="btn btn-success rounded-pill px-4 fw-bold shadow-sm" onclick="ejecutarCierreMasivo()">
                    <i class="fas fa-check-double me-1"></i> Aprobar & Acreditar Lote Masivo
                </button>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                <div class="card border-0 bg-secondary bg-opacity-10 p-3" style="border-radius: 14px; border-left: 4px solid #3b82f6 !important;">
                    <span class="text-white-50 small fw-bold text-uppercase">TOTAL EXPEDIENTES</span>
            ...
            <div class="col-md-3">
                <div class="card border-0 bg-secondary bg-opacity-10 p-3" style="border-radius: 14px; border-left: 4px solid #10b981 !important;">
                    <span class="text-white-50 small fw-bold text-uppercase">APROBADO PARA TRANSF.</span>
            ...
            <div class="col-md-3">
                <div class="card border-0 bg-secondary bg-opacity-10 p-3" style="border-radius: 14px; border-left: 4px solid #f59e0b !important;">
                    <span class="text-white-50 small fw-bold text-uppercase">RETENIDO EN AUDITORÍA</span>
            ...
            <div class="col-md-3">
                <div class="card border-0 bg-secondary bg-opacity-10 p-3" style="border-radius: 14px; border-left: 4px solid #8b5cf6 !important;">
                    <span class="text-white-50 small fw-bold text-uppercase">PRESTADORES / LOTES</span>
                            ...
                            @foreach($liquidacionesPrestadores as $liq)
                                <tr>
                                    <td class="ps-4">
                                        ...
                                        <small class="text-white-50">{{ $liq->tipo }}</small>
                                    </td>
                                    <td>
                                        <div class="small fw-bold text-info font-monospace">{{ $liq->cbu_alias }}</div>
                                        <small class="text-white-50">CUIT: {{ $liq->cuit }} | {{ $liq->banco }}</small>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if($liq->estado == 'aprobado_para_pago')
                                            <span class="badge bg-success text-white px-3 py-1.5 rounded-pill fw-bold shadow-sm"><i class="fas fa-check-circle me-1"></i> LISTO PARA TRANSFERIR</span>
                                        @else
                                            <span class="badge bg-warning text-dark px-3 py-1.5 rounded-pill fw-bold shadow-sm"><i class="fas fa-clock me-1"></i> EN AUDITORÍA FINAL</span>
                                        @endif
                                    </td>
                                    <td class="text-end pe-4">
                                        <a href="{{ route('liquidacion.exportar_interbanking') }}" class="btn btn-sm btn-outline-info rounded-pill px-3 fw-bold">
                                            <i class="fas fa-download me-1"></i> TXT CBU
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
